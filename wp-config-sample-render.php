 ...
 * 3. Set environment variables on Render for production
 */
 ...
 */
define( 'CHATBOT_PG_HOST', getenv('CHATBOT_PG_HOST') ?: 'YOUR_SUPABASE_HOST.supabase.co' );
...
define( 'CHATBOT_PG_PASSWORD', getenv('CHATBOT_PG_PASSWORD') ?: 'YOUR_SUPABASE_PASSWORD' );
define( 'CHATBOT_SUPABASE_ANON_KEY', getenv('CHATBOT_SUPABASE_ANON_KEY') ?: 'YOUR_SUPABASE_ANON_KEY' );
...
/** Debugging - set WP_DEBUG=true env var to enable */
